...
DOMAIN_SEEDS = {
    ...
    "cs": {
        "domain_name": "Commonsense Knowledge",
        "output_file": "corpus_cs.jsonl",
        "directions": [
            "health and personal hygiene",
            "nutrition and physical fitness",
            "safety, first aid, and disease prevention",
            "mental health and behavioral skills",
            "practical life and financial skills",
            "home, travel, and everyday technology",
            "basic science and the natural world",
            "society, civics, and culture",
        ],
    },
}
                ...
                [
                    {
                        ...
                        "content": (
                            ...
                            "Rules:\n"
                            "- each topic should be a specific concept, skill, or practice within the direction\n"
                            "- each topic should be something a curious person might google,"
                            " read about in a magazine, or learn from a health/life advice website\n"
                            "- not too broad (e.g. 'health') and not too niche (e.g. specific medical procedures)\n"
                            ...
                            "Examples of bad topics (too narrow or too academic):\n"
                            "- Cortisol-mediated stress response in the hypothalamic-pituitary axis\n"
                            "- Microbial biofilm formation on household surfaces\n\n"
                        ),
                    }
                ],
                temperature=0.6,
            ...
            [
                {
                    ...
                    "content": (
                        ...
                        f"Topic: {topic}\n\n"
                        "Rules:\n"
                        "- focus on a specific concept, practice, or real-world application within the topic\n"
                        "- each subtopic should have enough substance to fill a dedicated section on a"
                        " reliable website like Wikipedia, WebMD, or Investopedia\n"
                        "- aimed at an informed general audience, not academic researchers\n"
            ...
            [
                {
                    ...
                    "content": (
                        ...
                        "- use clear, everyday language with enough precision to return factual, structured content\n"
                        "- prefer queries that return results from health, education, or reference websites\n"
                        "- append terms like 'explained', 'how it works', 'tips', 'guide' where natural\n"
