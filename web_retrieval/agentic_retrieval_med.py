                ...
                [
                    {
                        ...
                        "content": (
                            ...
                            f" following clinical direction:\n\n{direction}\n\n"
                            "Rules:\n"
                            "- each topic should be a specific disease, syndrome,"
                            " drug class, or clinical procedure covered in medical"
                            " licensing exams (e.g. USMLE, MRCP, MedMCQA)\n"
                            "- specific enough to appear in a medical textbook chapter"
                            " or USMLE review, but NOT so narrow it only appears in"
                            " research papers\n"
                            ...
                            "Examples of bad topics (too narrow or research-style):\n"
                            "- RAAS pathway modulation in resistant hypertension\n"
                            "- Cytokine-mediated inflammation in atherosclerosis\n\n"
                        ),
                    }
                ],
                temperature=0.6,
            ...
            [
                {
                    "role": "user",
                    "content": (
                        "Generate exactly 2 focused subtopics for medical exam"
                        " preparation.\n\n"
                        f"Topic: {topic}\n\n"
                        "Rules:\n"
                        "- focus on clinically tested knowledge: etiology,"
                        " pathophysiology, diagnosis criteria, first-line treatment,"
                        " or complications\n"
                        "- each subtopic should map to a specific exam question"
                        " category (e.g. 'diagnosis', 'pharmacotherapy',"
                        " 'clinical presentation', 'complications')\n"
                        "- aimed at medical student / licensing exam level\n"
                        "- NOT cutting-edge research or niche mechanisms\n"
            ...
            [
                {
                    ...
                    "content": (
                        ...
                        "- use clear, precise terminology at medical textbook level\n"
                        "- prefer queries that return encyclopedia, institutional, or"
                        " medical education pages (e.g. StatPearls, MedScape, Mayo Clinic)\n"
                        "- append terms like 'explained', 'overview', 'guidelines',"
                        " 'symptoms and treatment' where natural\n"
...
class JudgeAgent:
    ...
    def score_doc_relevance(
        ...
        prompt = (
            ...
            "Task:\n"
            "Evaluate whether the webpage is relevant to the clinical topic below.\n"
            ...
            f"Clinical direction: {direction}\n"
            f"Topic: {topic}\n"
            f"Subtopic: {subtopic}\n"
            f"Query: {query}\n\n"
            f"Webpage:\nTitle: {doc.title}\nSnippet: {doc.snippet}\n\n"
